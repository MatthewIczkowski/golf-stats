...
export default function Home() {
  return (
    <div className="p-2 sm:p-6"> 
      <section className="flex flex-col sm:flex-row gap-4 items-center pb-4">
        <Image src={goat} alt="goat" width={180} height={180} />
        <section className="flex flex-col gap-2">
          <h1 className="text-2xl font-bold">Iczkowski <span className="text-xl text-gray-500">Matt</span></h1>
          <p className="text-gray-500 text-sm"> age - 30 years, 7 months</p>
      ...
      <section className="flex flex-col sm:grid sm:grid-cols-3 gap-4 pb-4 max-w-full">
        <div className="w-full min-h-96 sm:col-span-2">
          <ChartLineDefault />
        </div>
